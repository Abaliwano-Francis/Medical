                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="doctor" data-editable="false">Doctor/Nurse</th>
                                        <th data-field="symptoms" data-editable="false">Symptoms</th>
                                        <th data-field="Nn" data-editable="false">Next of Kin</th>
                                        <th data-field="status" data-editable="false">Re-assign Dr/Ns</th>
...
?>
                                    <tr>
                                        ...
                                        <td><?php echo $results['doctor']; ?></td>
                                        <td><?php echo $results['symptoms']; ?></td>
                                        <td><?php echo $results['next_of_kin']; ?></td>
                                        <td><a href="change_doctor.php?id=<?php echo $results['id'] ?>"><button data-toggle="tooltip" title="Edit" class="btn btn-primary">Ra-Assign</button></a></td>
                                        <td><?php echo $results['date_added']; ?></td>
                                        <td><a href="edit_patients.php?id=<?php echo $results['id'] ?>"><button data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                        <a href="confirm_delete_patient.php?id=<?php echo $results['id'] ?>"><button data-toggle="tooltip" title="Trash" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                   <tr>
                                        ...
                                        <th data-field="Nn" data-editable="false">Next of Kin</th>
                                        <th data-field="status" data-editable="false">Weight</th>
                                        <th data-field="date" data-editable="false">Date Added</th>
                                        <th data-field="action">Action</th>
                                    </tr>
                                </thead>
...
<?php 
include"includes/dbcon.php";
$sql = mysqli_query($con, "SELECT *, (SELECT name FROM doctors WHERE id=patients.doc_id) as doctor, (SELECT name FROM sys_users WHERE id=patients.addedby) as addedby FROM `patients` WHERE `status`='0'");
$No = 0;
while($results = mysqli_fetch_array($sql)){
    $No++
?>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                   <tr>
                                        ...
                                        <th data-field="md" data-editable="false">Medication</th>
                                        <th data-field="Nn" data-editable="false">Next of Kin</th>
                                        <th data-field="status" data-editable="false">Discharged Date</th>
                                        <th data-field="date" data-editable="false">Date Added</th>
                                        <th data-field="action">Action</th>
                                    </tr>
                                </thead>
