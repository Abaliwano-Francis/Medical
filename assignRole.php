...
<script>
var elemp = document.getElementById("role");
elemp.onchange = function(){
    var hiddenDivp = document.getElementById("dept");
    hiddenDivp.style.display = (this.value == "HOD") ? "block":"none";
};
</script>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="dept" style="display: none;">
                                 <div class="form-group">
                                    <div class="chosen-select-single">
