...
?>
                                    <tr>
                                        ...
                                        <td><a href="mute_workers.php?id=<?php echo $results['w_id'] ?>"><button data-toggle="tooltip" title="Mute" class="btn btn-danger">Mute</button></a></td>
                                        ...
                                        <a href="worker_details.php?id=<?php echo $results['w_id'] ?>"><button data-toggle="tooltip" title="View Details" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>List of <span class="table-project-n">Muted</span> Workers</h1>
                        </div>
                    </div>
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
...
?>
                                    <tr>
                                        ...
                                        <td><?php echo $results['address']; ?></td>
                                        <td><?php echo number_format($results['salary']); ?></td>
                                        <td><a href="unmute_workers.php?id=<?php echo $results['w_id'] ?>"><button data-toggle="tooltip" title="UnMute" class="btn btn-primary">UnMute</button></a></td>
