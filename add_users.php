...
if (isset($_POST['submit'])) {
    ...
    $Target = "images/u_profile/".basename($image);
    move_uploaded_file($_FILES["pic"]["tmp_name"], $Target);

    $query = mysqli_query($con, "INSERT INTO `sys_users`(`name`, `role`, `email`, `phone`, `address`, `username`, `password`, `pic`, `status`, `addedby`) VALUES ('$name','$role','$email','$phone','$address','$uname','$pass','$image','$status','$addedby')");
    if ($query) {
                    ...
                    <form id="add-department" action="#" class="add-department" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <?php 
                                include 'dbcon.php';
                                $sql = mysqli_query($con, "SELECT * FROM `departments` WHERE 1");
